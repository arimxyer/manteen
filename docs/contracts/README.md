...
These documents define current product behavior and the rationale code comments cite. Later
numbered decisions or explicitly linked contracts supersede earlier prose; implementation and
release receipts live in the sibling handoff and release groups.
