...
These are bounded receipts for completed implementation milestones. They record what a milestone
proved at the time; the roadmap and current contracts decide whether later work superseded any
behavior.
...
| [`update-verification-handoff.md`](update-verification-handoff.md) | Historical post-update project verification contract. |
| [`upstream-removal-handoff.md`](upstream-removal-handoff.md) | Explicit upstream-file removal transaction. |
